...
public class RecentDocumentsKDE : DataProvider
{
  ...
  private const string FILE_ATTRIBUTE_QUERY_RECENT =
    FileAttribute.STANDARD_TYPE + ATTRIBUTE_SEPARATOR +
    FileAttribute.TIME_MODIFIED + ATTRIBUTE_SEPARATOR +
    FileAttribute.TIME_MODIFIED_USEC;
  private const string FILE_ATTRIBUTE_QUERY_SUBJECT =
    FileAttribute.STANDARD_CONTENT_TYPE + ATTRIBUTE_SEPARATOR +
    FileAttribute.TIME_MODIFIED + ATTRIBUTE_SEPARATOR +
    FileAttribute.TIME_MODIFIED_USEC + ATTRIBUTE_SEPARATOR +
    FileAttribute.TIME_CHANGED + ATTRIBUTE_SEPARATOR +
